...
Route::middleware('auth:member')->group(function () {
    Route::get('/member/products/create', [ProductController::class, 'create'])
        ->name('products.create');

    Route::post('/member/products/confirm', [ProductController::class, 'confirm'])
        ->name('products.confirm');

    Route::match(['GET', 'POST'], '/member/products/back', [ProductController::class, 'backToForm'])
        ->name('products.back');

    Route::post('/member/products/store', [ProductController::class, 'store'])
        ->name('products.store');

    // Ajax用
    Route::post('/member/products/get-subcategories', [ProductController::class, 'getSubcategories'])
        ->name('products.getSubcategories');

    Route::post('/member/products/upload-image', [ProductController::class, 'uploadImage'])
