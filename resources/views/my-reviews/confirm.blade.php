...
<div class="review-confirm-container">
    ...
    <div class="confirm-section">
        ...
        <div class="confirm-item">
            ...
            <div class="confirm-value">{{ $data['evaluation'] }}</div>
        </div>

        <div class="confirm-item">
            <div class="confirm-label">商品コメント</div>
            <div class="confirm-value comment-text">{{ $data['comment'] }}</div>
        </div>
    </div>

    <div class="button-group">
        <form method="POST" action="{{ route('my-reviews.update', $review->id) }}">
            @csrf
            <button type="submit" class="btn btn-primary">更新する</button>
        </form>
        
        <form method="POST" action="{{ route('my-reviews.back', $review->id) }}">
            @csrf
